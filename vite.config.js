...
export default defineConfig(({ mode }) => {
  ...
  const { VITE_CONSENTING_API_HOST, VITE_AUTHORIZED_API_HOST, VITE_SYSADMIN_API_HOST, VITE_ACKNOWLEDGE_ENTITY_API_HOST, VITE_ENTITY_API_HOST, VITE_REGISTER_ENTITY_API_HOST, VITE_REGISTER_CONSENTER_API_HOST, VITE_STACK_CLOUDFRONT_DOMAIN } = env;
  ...
  return {
    ...
    server: {
      proxy: {
        ...
        '/parameters': `${VITE_STACK_CLOUDFRONT_DOMAIN}/parameters`
      }
    }
  }
});
