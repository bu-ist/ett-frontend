...
export default function EditAdminDetailsModal({ isOpen, onClose, adminInfo, onSaveSuccess }) {
    ...
    const isEmailChanged = submittedData 
        ? submittedData.new_email !== adminInfo.email
        : watchEmail !== adminInfo.email;
    ...
    function handleClose() {
        ...
        if (apiState === 'success' && submittedData && submittedData.new_email !== adminInfo.email) {
            signOut(appConfig.cognitoDomain, appConfig.entityAdmin.cognitoID);
            return;
        }
...
EditAdminDetailsModal.propTypes = {
