...
export default function PrivacyPolicyPage() {
    return (
        <>
            <Text>
                Ex et consectetur incididunt aute fugiat dolor laboris incididunt consequat est velit dolore officia deserunt.
                ...
                Duis anim excepteur mollit excepteur sit cupidatat Lorem ea proident minim.
            </Text>
            <PrivacyPolicyBox />
        </>
    );
