async function rescindConsentAPI(appConfig, accessToken, email) {
    ...
    const response = await fetch(apiUrl, {
        ...
        'ettpayload': JSON.stringify({ task: 'rescind-consent',  parameters: { email: email} })
        }
    });
