// Formats the payload and saves the exhibit form to the API.
async function saveExhibitFormAPI(appConfig, accessToken, contactList, entityId, email, formConstraint) {
    ...
    // Send a request to the API to save the exhibit form.
    const response = await fetch(apiUrl, {
        ...
        headers: {
            ...
            'ettpayload': JSON.stringify({ task: 'save-exhibit-form', parameters: params })
        }
    });
